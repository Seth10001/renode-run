...
def parse_args():
    ...
    parser.add_argument('-a', '--artifacts', dest='artifacts_path', default=str(default_renode_artifacts_dir), help='Path for renode-run artifacts (e.g. config, Renode installations)')
